...
alias gg='git log --graph --oneline --decorate --format="%C(auto)%h%Creset%C(auto)%d%Creset %s %C(brightblack)- %aN <%aE> - %ad%Creset" --date=short --exclude=refs/stash'
alias ga='git log --graph --oneline --decorate --format="%C(auto)%h%Creset%C(auto)%d%Creset %s %C(brightblack)- %aN <%aE> - %ad%Creset" --date=short --exclude=refs/stash --all'
